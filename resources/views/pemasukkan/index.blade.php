                                                ...
                                                <div>
                                                    ...
                                                    <div class="col">
                                                        <input type="date" name="tanggal" class="form-control"
                                                            placeholder="Masukkan tanggal pemasukkan" required>
                                                    </div>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="col">
                                                        <input type="number" name="nominal" class="form-control"
                                                            placeholder="Masukkan nominal pemasukkan">
                                                    </div>
                                                </div>
                                                <div>
                                                    ...
                                                    <div class="col">
                                                        <input type="text" name="keterangan" class="form-control"
                                                            placeholder="Masukkan keterangan pemasukkan">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="col">
                                                                <select name="kategori" class="form-control" required>
                                                                    <option value="Dana Dekanat"
                                                                        {{ $data->kategori === 'Dana Dekanat' ? 'selected' : '' }}>
                                                                        Dana Dekanat</option>
                                                                    <option value="Kas"
                                                                        {{ $data->kategori === 'Kas' ? 'selected' : '' }}>
                                                                        Kas</option>
